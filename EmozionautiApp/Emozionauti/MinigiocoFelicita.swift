...
struct MinigiocoFelicita: View {
    ...
    let vectorImage = [Image("astronauta1"), Image("astronauta2"),Image("astronauta3"),Image("astronauta4"),Image("astronauta5"),Image("astronauta6"),Image("pianeta1"),Image("pianeta2"),Image("pianeta3"),Image("pianeta4")]
